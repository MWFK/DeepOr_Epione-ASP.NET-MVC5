    ...
    public class Context : IdentityDbContext<IdentityUser, IdentityRole, string, IdentityUserLogin, IdentityUserRole, IdentityUserClaim>
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
           ...
           modelBuilder.Conventions.Add(new Conventions.DateTime2Convention());
            ...
            modelBuilder.Entity<Motif>().ToTable("Motif");
            modelBuilder.Entity<Doctolib>().ToTable("Doctolib");
            modelBuilder.Entity<DoctolibDoctor>().ToTable("DoctolibDoctor");
            modelBuilder.Entity<DoctolibOther>().ToTable("DoctolibOther");
