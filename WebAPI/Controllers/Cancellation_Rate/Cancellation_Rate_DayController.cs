...
{
    public class Cancellation_Rate_DayController : ApiController
    {
        ...
        // GET: api/Cancellation_Rate_Day
        //http://localhost:54656/api/Cancellation_Rate_Day
        public float Get()
        {
            return X.Cancellation_Rate_Per_Day();
        }
